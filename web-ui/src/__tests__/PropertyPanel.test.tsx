 ...
 *   - ThreadGroup form renders with correct fields
 *   - HTTPSampler form renders with correct fields
 *   - Inline validation: invalid thread count shows error
 *   - Inline validation: invalid port number shows error
 *   - Valid submit updates testPlanStore via updateProperty
 *   - Unknown node type shows "no editable properties" message
 */
