 ...
 *   - Renders table with plugin name, version, status for each plugin
 *   - Status badge reflects the correct label for PENDING / ACTIVE / QUARANTINED
 *   - Admin actions (Activate, Remove) are shown when isAdmin=true
 *   - Admin actions are hidden when isAdmin=false
 *   - Activate button is absent for ACTIVE plugins
 *   - onDelete is called with the correct plugin id
 *   - onActivate is called with the correct plugin id
 */
