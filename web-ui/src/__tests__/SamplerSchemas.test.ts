/**
 * Unit tests for sampler Zod schemas.
 *
 * Each schema is verified to:
 *   - Accept valid default values without errors.
 *   - Reject invalid values and surface the correct error message.
 */
