/**
 * NodeRenderer — renders a single node row in the test plan tree.
 *
 * Displays: drag handle, type icon (Lucide React), node name, and a "disabled"
 * badge when the node's enabled flag is false.
 */
