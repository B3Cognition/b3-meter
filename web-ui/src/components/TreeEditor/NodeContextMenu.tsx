/**
 * NodeContextMenu — right-click context menu for tree nodes.
 *
 * Provides a full cascading submenu matching JMeter 5.x Add menu,
 * plus Copy, Paste, Move Up, Move Down, Duplicate, Enable/Disable, and Delete.
 */
