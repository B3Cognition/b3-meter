/**
 * TreeSearch — Ctrl+F search overlay for the test plan tree.
 *
 * Features:
 *   - Case-insensitive substring matching on node names
 *   - Shows "N of M" match count
 *   - Enter cycles through matches (Shift+Enter goes backward)
 *   - Escape closes the search
 *   - Highlights matching text in tree node names
 */
