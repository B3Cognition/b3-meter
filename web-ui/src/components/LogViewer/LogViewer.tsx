/**
 * LogViewer — collapsible panel showing application log entries.
 *
 * Displays timestamped log entries with level indicators (INFO/WARN/ERROR).
 * Auto-scrolls to bottom on new entries. Supports clear and toggle visibility.
 */
