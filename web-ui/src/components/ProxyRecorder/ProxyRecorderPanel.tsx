/**
 * ProxyRecorderPanel — configure and control the HTTP proxy recorder.
 *
 * Features:
 * - Configuration form: port, target base URL, include/exclude patterns,
 *   capture headers, capture body flags.
 * - Start / Stop recording buttons.
 * - Live list of captured requests (method, URL, status code, elapsed ms).
 * - "Refresh" button to re-fetch the captured list.
 * - "Apply to Test Plan" button — converts captures to HTTPSampler nodes and
 *   calls the onApply callback with the resulting node list.
 */
