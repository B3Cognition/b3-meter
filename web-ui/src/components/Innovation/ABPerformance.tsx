/**
 * ABPerformance — Differential A/B Performance Testing panel.
 *
 * Runs two identical load tests (sequentially) against URL A and URL B,
 * then compares metrics side-by-side with delta and % change indicators.
 */
