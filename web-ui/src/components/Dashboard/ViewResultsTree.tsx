/**
 * ViewResultsTree — per-sample result viewer, similar to JMeter's View Results Tree listener.
 *
 * Left panel: scrollable list of sample results with pass/fail indicators.
 * Right panel: request/response details for the selected sample.
 * Filter bar: show all / pass only / fail only.
 *
 * Uses mock/synthetic data derived from the runStore's MetricsBucket ring buffer until
 * the backend supports per-sample streaming. Each bucket is projected into a SampleResult.
 */
