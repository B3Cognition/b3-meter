/**
 * Zod validation schemas for additional Controller elements (Phase 2).
 *
 * Extends the controllers defined in controllerSchemas.ts with ForEach,
 * Throughput, and Once Only controllers.
 */
