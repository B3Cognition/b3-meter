/**
 * Zod validation schemas for protocol sampler elements added in Phase 6.
 *
 * Covers: gRPC, MQTT, WebRTC, DASH, HLS, SSE, and WebSocket samplers.
 * FTP and LDAP already have dedicated schema files.
 */
