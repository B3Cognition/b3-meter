/**
 * Zod validation schemas for legacy/niche sampler elements.
 *
 * Covers: SOAP Sampler, Mail Reader, BSF Sampler, Access Log Sampler,
 * AJP Sampler, JUnit Sampler, JMS Publisher, JMS Subscriber.
 */
