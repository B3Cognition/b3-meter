/**
 * DistributedConfig — worker node management and distributed run launcher.
 *
 * - Lists all registered workers with online/offline/busy status badges.
 * - Allows the user to select workers via checkboxes for an upcoming run.
 * - Provides an inline form to register new workers (hostname + port).
 * - Provides a Remove button to de-register individual workers.
 * - "Start Distributed Run" button is enabled when at least one worker is
 *   selected and a planId is provided.
 */
