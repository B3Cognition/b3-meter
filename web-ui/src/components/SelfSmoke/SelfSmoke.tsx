/**
 * SelfSmoke — Self Smoke regression test panel.
 *
 * Manages mock server lifecycle and runs smoke test plans sequentially,
 * displaying health status and pass/fail results in a unified dashboard.
 */
