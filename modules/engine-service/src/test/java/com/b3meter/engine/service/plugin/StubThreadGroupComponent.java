...
/**
 * Test-only stub simulating a Thread Group component for ServiceLoader discovery tests.
 *
 * <p>Declared in
 ...
 */
public final class StubThreadGroupComponent implements JMeterComponent {

    /** Component name used as the lookup key in {@link ComponentRegistry}. */
    public static final String NAME     = "ThreadGroup";

    /** Category string returned by this stub. */
    public static final String CATEGORY = "controller";
